        ...
        <div class="row justify-content-center align-items-center flex-column">
            ...
            <form class="col-md-5 bg-light pb-2 pt-2" method="post">
                ...
                if (!empty($_POST['quantidade']) && !empty($_POST['ucompra']) && !empty($_POST['ucusto'])) {
                    ...
                    $ucusto = addslashes(floatval($_POST['ucusto']));
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="ucompra" class="form-control" placeholder="Digite a última compra">
                </div>
                <div class="form-group">
                    <label for="ucusto">Último Custo</label>
